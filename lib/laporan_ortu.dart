...
class LaporanOrtuScreen extends StatefulWidget {
  const LaporanOrtuScreen({super.key});

  @override
  State<LaporanOrtuScreen> createState() => _LaporanOrtuScreenState();
}

class _LaporanOrtuScreenState extends State<LaporanOrtuScreen> {
  late Future<List<Map<String, dynamic>>> _reportsFuture;
  late Future<Map<String, double>> _weeklySummaryFuture;

  static const Color _hadirColor = Color(0xFF2E7D32); // Green
  static const Color _tidakHadirColor = Color(0xFFC62828); // Red
  ...
  Future<void> _logout() async {
    try {
      ...
      await prefs.remove('is_ortu_logged_in');
    ...
    try {
      ...
      for (var report in reports) {
        ...
        rows.add([
          ...
          muridTidakHadir.join(', ') // Join list into a single string
        ]);
      }
